...
mongoose.connect(process.env.MONGODB_URL || 'mongodb+srv://amazon:Batman0202@cluster0.sevox.mongodb.net/amazon-fake?retryWrites=true&w=majority', {
        ...
        if (message.isAdmin) {
            ...
            if (admin) {
                ...
                io.to(socket.id).emit('message', {
                    name: 'Admin',
                    body: 'Sorry, I am currently offline right now.',
                });
            }
        }
    });
