...
function ProductScreen( props ) {
    ...
    const { loading: loadingReviewCreate, error: errorReviewCreate, success: successReview } = productReviewCreate;
                            ...
                            {userInfo ? (
                                <form className="form" onSubmit = {submitHandler}>
                                    ...
                                    <div>
                                        ...
                                        <textarea value = {comment} id="comment" onChange = {(e) => setComment(e.target.value)}>
